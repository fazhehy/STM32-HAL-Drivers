...
void MX_DSIHOST_DSI_Init(void)
{
  ...
  PhyTimings.ClockLaneHS2LPTime = 32;
  PhyTimings.ClockLaneLP2HSTime = 40;
  PhyTimings.DataLaneHS2LPTime = 18;
  PhyTimings.DataLaneLP2HSTime = 30;
  ...
  VidCfg.HorizontalSyncActive = 16;
  VidCfg.HorizontalBackPorch = 41;
  VidCfg.HorizontalLine = 1732;
  VidCfg.VerticalSyncActive = 4;
  VidCfg.VerticalBackPorch = 8;
  VidCfg.VerticalFrontPorch = 6;
  VidCfg.VerticalActive = 712;
